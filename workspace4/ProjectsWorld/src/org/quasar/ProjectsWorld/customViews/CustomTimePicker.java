package org.quasar.ProjectsWorld.customViews;
...
public class CustomTimePicker extends FrameLayout {
    ...
    public interface OnTimeChangedListener {
         ...
         */
        void onTimeChanged(CustomTimePicker view, int hourOfDay, int minute, int seconds);
    }
    ...
    public CustomTimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        int layout = context.getResources().getIdentifier("time_picker_widget", "layout", context.getPackageName());
     ...
     * initialize
     */
    public void init(Integer hour, Integer minute, Integer second){
