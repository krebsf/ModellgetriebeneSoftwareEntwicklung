...
public class StationDetailFragment extends Fragment implements PropertyChangeListener, DetailFragment{
	...
	private EditText meanActualValueView;
	private EditText meanVarianceValueView;
	private EditText numberOfEntriesView;
	...
	**********************************************************************/
	...
	public View setViewDetailData()
	{
		...
		if (station != null)
		{
			...
			((TextView) activeView.findViewById(R.id.station_detail_meanactualvalue_value)).setText("" + station.meanActualValue());
			((TextView) activeView.findViewById(R.id.station_detail_meanvariancevalue_value)).setText("" + station.meanVarianceValue());
			((TextView) activeView.findViewById(R.id.station_detail_numberofentries_value)).setText("" + station.numberOfEntries());
			((TextView) activeView.findViewById(R.id.station_detail_target_value)).setText("" + station.target());
		}
		return rootView;
	}
	...
	public Station ActionViewNew()
	{
		...
		return new Station(-1, -1, temp_name, -1, temp_target);
	}
