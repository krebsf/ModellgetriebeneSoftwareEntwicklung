...
**********************************************************************/
package org.quasar.IceCream2.presentationLayer.CalendarDate;
...
import org.quasar.IceCream2.presentationLayer.Entry.EntryActivity;
...
import org.quasar.IceCream2.presentationLayer.CalendarDate.CalendarDateDetailFragment;
import org.quasar.IceCream2.businessLayer.CalendarDate;
...
public class CalendarDateDetailFragment extends Fragment implements PropertyChangeListener, DetailFragment{
	...
	**********************************************************************/
	...
	public void onAttach(Activity activity)
	{
		...
		{
			if (activity.getClass() != EntryActivity.class && !(activity instanceof Callbacks))
			{
	...
	public CalendarDate ActionViewNew()
	{
		...
		return new CalendarDate(temp_day, temp_month, null, temp_year);
	}
