...
USE-Spezifikation und die Anreicherung des Modells mit OCL-Constraints werden in Abschnitt \ref{ssec:use} erläutert. Ein Werkzeug zur Validierung des Modells wird im darauffolgenden Abschnitt \ref{sec:use_tool} vorgestellt. Abschnitt \ref{JUSE4Android} präsentiert das Tool JUSE4Android sowie die Ergebnisse der untersuchten Fragestellungen. Im letzten Abschnitt wird die Arbeit zusammengefasst und die Ergebnisse werden reflektiert.
