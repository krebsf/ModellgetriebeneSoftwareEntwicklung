...
\section{\uppercase{Beschreibung der Anwendung}}\label{sec:iceCream}
\noindent
...
\subsection{USE-Tool}\label{sec:use_tool}
...
\section{\uppercase{JUSE4Android}}\label{JUSE4Android}
